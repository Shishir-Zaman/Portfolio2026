...
export type Project = {
  ...
  image: string;
  gallery?: string[];
  galleryGroups?: GalleryGroup[];  // Organized gallery sections for case studies
  description?: string;
  year?: string;
  isFeatured?: boolean;            // Controls homepage featured section
  // Client / Case Study fields
  client?: string;
  websiteUrl?: string;
...
export type PricingPackage = {
  ...
  features: string[];
  isPopular?: boolean;
  exampleProjects?: string[];     // Project IDs — pulls images from those projects
  exampleImages?: string[];       // Direct image URLs (override)
};

// ─── NAV LINKS (Default — admin-editable via Settings) ───────
...
export const PROJECTS: Project[] = [
  // ── ZALFII — Fragrance Brand ──────────────────────────────
  {
    id: "zalfii-brand-identity",
    title: "ZALFII BRAND IDENTITY",
    tags: ["Brand Identity", "Logo Design", "Packaging Design"],
    image: "", // Add cover image via admin
    isFeatured: true,
    client: "Zalfii",
    ...
    gallery: [],
    galleryGroups: [
      { title: "Logo & Brand Mark", images: [] },
      { title: "Packaging Design", images: [] },
      { title: "Stall & Event Design", images: [] },
      { title: "Social Media Content", images: [] },
    ]
  },
  // ── MAINUL — Lifestyle Brand ──────────────────────────────
  {
    id: "mainul-lifestyle-brand",
    title: "MAINUL LIFESTYLE",
    tags: ["Brand Identity", "Social Media Design", "Graphics & Visual Design"],
    image: "", // Add cover image via admin
    isFeatured: true,
    client: "Mainul Lifestyle",
    ...
    gallery: [],
    galleryGroups: [
      { title: "Logo & Branding", images: [] },
      { title: "Social Media Posts", images: [] },
      { title: "Promotional Materials", images: [] },
    ]
  },
  // ── TECH-O ────────────────────────────────────────────────
  {
    ...
    gallery: [],
    galleryGroups: [
      { title: "Logo Suite", images: [] },
      { title: "Brand Guidelines", images: [] },
    ]
  },
  // ── BANDY ─────────────────────────────────────────────────
  {
    ...
    tags: ["Graphics & Visual Design", "Packaging Design", "Social Media Design"],
...
// Dynamically generated from the isFeatured flag above
// The CMS (admin) overrides this via Redis
...
export const PROJECT_CATEGORIES: Category[] = [
  ...
  { id: "graphics-design", name: "Graphics & Visual Design" },
...
export const PRICING_PACKAGES: PricingPackage[] = [
  ...
  },
  {
    ...
    isPopular: true,
    exampleProjects: ["zalfii-brand-identity", "mainul-lifestyle-brand"]
  },
  {
    id: "premium",
    ...
    exampleProjects: ["zalfii-brand-identity", "tech-o-brand"]
  }
];
