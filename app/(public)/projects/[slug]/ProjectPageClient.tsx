      ...
      <div className="flex flex-col gap-6">
        ...
        >
          {project.tags.map((tag) => (
            <span
              key={tag}
              className="px-4 py-2 text-xs font-medium rounded-full bg-white/5 border border-white/10 text-[var(--color-teal-accent)] tracking-widest uppercase font-sans"
            >
              {tag}
            </span>
          ))}
        ...
        >
          ...
          {project.description ? (
            ...
            <p className="text-lg text-white/40 font-sans leading-relaxed italic">
              Project description coming soon — add a `description` field in
              content.ts.
            </p>
          )}
        ...
        >
          {[
            ...
            <div key={i} className="p-6 border-b border-white/8 last:border-0">
              ...
              <p className="text-white font-medium text-sm uppercase tracking-wider font-sans">
                {item.value}
              </p>
            </div>
          ))}
